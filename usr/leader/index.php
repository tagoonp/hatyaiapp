...
<html>
  ...
  <body Onload="bodyOnload();">
    ...
    <div class="leftPanel">
      ...
      <button type="button" name="button" id="btnManagement" class="ms-btn btn-ms-map2 border-shadow1" style="font-size: 0.9em; margin-top: 25px;" title="จัดการข้อมูล"><i class="fa fa-wrench"></i></button>
